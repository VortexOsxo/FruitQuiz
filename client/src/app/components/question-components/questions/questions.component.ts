...
import { VOID_QCM_QUESTION, VOID_QRL_QUESTION, VOID_QRE_QUESTION } from '@app/consts/question.consts';
...
export class QuestionsComponent implements OnInit, OnDestroy {
    ...
    createQREQuestion(question?: Question) {
        this.openEditDialog(question ?? VOID_QRE_QUESTION);
    }
