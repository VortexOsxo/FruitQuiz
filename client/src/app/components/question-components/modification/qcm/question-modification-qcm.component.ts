...
export class QuestionModificationQCMComponent extends QuestionModificationBase implements OnInit {
    ...
    get responsesValidity(): InputValidity {
        return this.showValidation ? 
            this.questionValidationService.validateResponses(this.question.choices) :
    ...
    getChoiceTextValidity(choice: Choice): InputValidity {
        return this.showValidation ? 
            this.questionValidationService.validateChoiceText(choice.text) :
            { isValid: true, errorMessage: '' };
    }
    ...
    onImageUploaded(imageUrl: string, question: Question): void {
        question.imageId = imageUrl;
    }
