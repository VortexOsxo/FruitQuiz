...
import { NO_QUESTION_FILTER, VOID_QRL_QUESTION, VOID_QCM_QUESTION, VOID_QRE_QUESTION } from '@app/consts/question.consts';
...
export class QuestionService implements OnDestroy {
    ...
    createVoidQREQuestion(): Question {
        return VOID_QRE_QUESTION;
    }
